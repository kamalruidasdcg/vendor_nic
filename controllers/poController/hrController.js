...
const { HR_DEPT } = require("../../lib/tableName");
...
const { HR } = require("../../lib/depertmentMaster");
...
const hrComplianceUpload = async (req, res) => {
  ...
  // return  resSend(res, true, 200, "file hrupleeoaded!", `req`, null);
    try {
        ...
        const { q, val } = generateQuery(INSERT, HR_DEPT, insertObj);
