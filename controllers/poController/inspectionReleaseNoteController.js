  ...
  try {
    ...
    if (response.rowCount) {
      ...
      resSend(
        ...
        true,
        200,
        "Ispection Release Note inserted successfully !",
        response,
        null
      );
    } else {
...
const list = async (req, res) => {
  try {
    ...
    resSend(res, true, 200, "Inspection Release Note fetched", result.rows, "");
  } catch (err) {
